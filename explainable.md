...
become: true: This option instructs Ansible to run the tasks below with elevated privileges (typically root) on the target machines. This is frequently required for package management and configuration updates.
